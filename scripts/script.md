...
## User Does Not Want To Go To This Event
...
> Answer any questions on the fly - we are learning about this option
...
- Thanks so much. We aren’t ready to start introducing people to one another yet. This is a limited version of the final functionality of the _Movement_. However when we have this ready we’ll let you know right away.

## User Chooses Successfully

- Right on! ✊

> Generate calendar event file, download and send to user
...
> Set name to: Movement Chat

> Set description to: A conversation between you and the organiser of XXXXX, you will be going to on XXXXXXX.
